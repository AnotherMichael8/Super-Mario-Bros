...
{
    public class LeftAnimationFlowerSprite : AbstractPlayerSprite
    {
        //private Rectangle[] spriteAnimation = { new Rectangle(80, 328, 16, 32), new Rectangle(112, 328, 16, 32), new Rectangle(48, 328, 16, 32) };
        public LeftAnimationFlowerSprite(Texture2D texture, PowerUps powerUp, IPlayerSprite previousSprite) : base(texture, powerUp)
        {
        ...
        {
            Rectangle destinationRectangle = new Rectangle((int)position.X - CameraController.CameraPositionX, (int)position.Y + (64 - sourceRectangle.Height * 2) + CameraController.CameraPositionY, (int)Globals.BlockSize, sourceRectangle.Height * 2);

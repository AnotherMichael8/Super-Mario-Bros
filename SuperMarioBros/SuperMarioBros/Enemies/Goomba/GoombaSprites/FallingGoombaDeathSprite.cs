...
namespace SuperMarioBros.Enemies.Goomba.GoombaSprites
{
    public class FallingGoombaDeathSprite : IEnemySprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 position)
        {
            ...
            spriteBatch.Draw(texture, destinationRectangle, sourceRectangle, Color.White, 0, new Vector2(0), SpriteEffects.FlipVertically, 0.001f);
        }
    }
}

...
{
    public class WonderFlowerSprite : ICollectiblesSprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 position, Color color)
        {
            ...
            spriteBatch.Draw(texture, destinationRectangle, sourceRectangle, color, 0, new Vector2(0), SpriteEffects.None, 0f);
            spriteBatch.Draw(texture, auraDestinationRectangle, flowerAuraSourceRectangle, auraColor * 0.7f, rotation, origin, SpriteEffects.None, 0.001f);
        }
    }
}
